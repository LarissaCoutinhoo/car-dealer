package com.devSuperior.car_dealer.config;
import com.devSuperior.car_dealer.domain.SaleRecord;
import com.devSuperior.car_dealer.writer.SalesReportWriter;
...
public class SalesReportJobConfig {
    ...
    @Bean // monta o step: "etapas" dentro do job
